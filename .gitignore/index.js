...
bot.on("message", async function(message) {
    ...
    switch (args[0].toLowerCase()) {
            ...
            case "unit":
            var embed = new Discord.RichEmbed()
                .addField("Groupe Unit ** @Full Patch **", "Voici votre unit @Full Patch https://units.arma3.com/unit/brotherhood-hl")
                .setColor("#3b9908")
            ...
            case "stuff":
            var embed = new Discord.RichEmbed()
                .addField("Package **Sépa**: Tenue, Gilet, Sac, Béret, Bandanas(non obligé)", "Outils de crochetage+serrurier, Lampe frontal, Bandage x10, GPS x1, Serflex x6, pince coupante x1, Chargeur (entre x6 et x11 + le chargeur engagé), Roue de secours x2 ou x4, bouteille d'eau x10, Nourriture (cela depend se que tu a)")
                .addField("Package **Civil**: Tenue, Sac, Gilet+Bandanas(non obligé) dans le sac", "Outils de crochetage+serrurier, Lampe frontal, Bandage x10, GPS x1, Serflex x6, pince coupante x1, Chargeur (entre x4 et x6 + le chargeur engagé), Roue de secours x2 ou x4, bouteille d'eau x10, Nourriture (cela depend se que tu a)")
                .setColor("#3b9908")
